...
def main():
    ...
    REQUEST_LIST = [['float', 'price of the meal']]
    ...
    #  the costs of the meal to the user.
...
# s an introduction to the program and describes what it does.
def fluffy_intro():
